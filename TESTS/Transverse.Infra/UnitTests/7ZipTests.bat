...
:PartialUnZip_Nominal_ShouldUnZipOneOfTheZipFolder
    ...
    SET __ZIP_CONTENT_TO_UNZIP__=%FOLDER_TO_ZIP_NAME%/%TRANSVERSE_TESTS_SUBFOLDER_TO_ZIP_NAME%
...
:PartialUnZip_Nominal2_ShouldUnZipOneOfTheZipFolder
    ...
    SET __ZIP_CONTENT_TO_UNZIP__=%FOLDER_TO_ZIP_NAME%/%TRANSVERSE_TESTS_SUBFOLDER_TO_ZIP_NAME%/%TRANSVERSE_TESTS_SUBFOLDER2_TO_ZIP_NAME%
    CALL :PartialUnZipToTargetFolder "%__ZIP_FILE_FULLNAME_WITH_OR_WITHOUT_EXTENSION__%" "%__ZIP_CONTENT_TO_UNZIP__%" "%__TARGET_FOLDER__%"
...
:PartialUnZip_Nominal_ShouldUnZipOneOfTheZipFile
    ...
    SET __ZIP_CONTENT_TO_UNZIP__=%FOLDER_TO_ZIP_NAME%/%TRANSVERSE_TESTS_FILE_TO_ZIP_1_NAME_EXT%
    CALL :PartialUnZipToTargetFolder "%__ZIP_FILE_FULLNAME_WITH_OR_WITHOUT_EXTENSION__%" "%__ZIP_CONTENT_TO_UNZIP__%" "%__TARGET_FOLDER__%"
