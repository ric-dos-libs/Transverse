...
SET EXTERNAL_TESTING_LIB_INFRA_API_ENUMS_PATH=%TESTING_LIB_INFRA_API_ENUMS_PATH%
SET EXTERNAL_TESTING_LIB_INFRA_API_FRONT_CONTROLLER_SCRIPT=%TESTING_LIB_INFRA_API_FRONT_CONTROLLER_SCRIPT%
