...
SET TESTING_LIB_DOMAIN_SCRIPTS_PATH=%TESTING_LIB_DOMAIN_PATH%/Scripts
SET TESTING_LIB_DOMAIN_SCRIPTS_ENUMS_PATH=%TESTING_LIB_DOMAIN_SCRIPTS_PATH%/Enums
...
SET TESTING_LIB_INFRA_ASSETS_SCRIPTS_PATH=%TESTING_LIB_INFRA_ASSETS_PATH%/Scripts
