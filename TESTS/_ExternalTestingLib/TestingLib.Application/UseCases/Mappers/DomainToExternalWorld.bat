...
SET m_CURRENT_NAMESPACE_m=TestingLib.Application.UseCases.Mappers
SET _m_CURRENT_SCRIPT_NAME_EXT_m_=%~nx0

SET _$m_CURRENT_SCRIPT_PATH_m$_=%~dp0


SET TESTING_LIB_APPLICATION_COMMON_PATH=%_$m_CURRENT_SCRIPT_PATH_m$_%../../_Common

REM Recup. de TESTING_LIB_COMMON_CHECK_FATAL_ERRORS_SCRIPT et TESTING_LIB_COMMON_VARS_SCRIPT.
REM et TESTING_LIB_APPLICATION_ENUMS_ASSERTION_RESULT_SCRIPT
...
SETLOCAL
    ...
    CALL "%TESTING_LIB_COMMON_VARS_SCRIPT%" GetVarValue "ENUM_CONVERSION_" "%__DOMAIN_VALUE__%" __CONVERTED_VALUE__
    CALL "%TESTING_LIB_COMMON_CHECK_FATAL_ERRORS_SCRIPT%" CheckVarExists "__CONVERTED_VALUE__"
