...
CALL "%TESTING_LIB_DOMAIN_COMMON_SERVICES_PATH%/AssertionsResultEvaluatorService.bat" GetIsBetweenAssertionResult %2 %3 %4 __ASSERTION_RESULT_ID__
@REM ECHO __ASSERTION_RESULT_ID__='!__ASSERTION_RESULT_ID__!'  for   %2 dans plage [%3,%4[
...
@REM ECHO __ASSERTION_RESULT_LABEL__='!__ASSERTION_RESULT_LABEL__!'  for  %2 dans plage [%3,%4[

Rem Invocation du service d'affichage de résultat d'Assertion.
CALL "%TESTING_LIB_DOMAIN_COMMON_SERVICES_PATH%/AssertionResultDisplayerService.bat" IsBetweenAssertionResult "!__ASSERTION_RESULT_ID__!" "!__ASSERTION_RESULT_LABEL__!"  %2 %3 %4
