...
CALL "%TESTING_LIB_DOMAIN_COMMON_SERVICES_PATH%/AssertionResultDisplayerService.bat" DiskElementDoesntExistAssertionResult "!__ASSERTION_RESULT_ID__!" "!__ASSERTION_RESULT_LABEL__!"  %2
