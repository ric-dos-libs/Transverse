...
REM et TRANSVERSE_COMMON_CHECK_FATAL_ERRORS_SCRIPT, TRANSVERSE_COMMON_CONSTANTS_SCRIPT
...
SETLOCAL ENABLEDELAYEDEXPANSION 
    ...
    SET TRANSVERSE_UNDER_TEST_NAME=String.bat
...
:RepeatString_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" RepeatString "%__SOURCE_STRING__%" "%__NB_REPLICATE__%" __RESULT__
