...
SET TRANSVERSE_TESTS_COMMON_PATH=%CURRENT_SCRIPT_PATH%..


REM ------------------- VERIFS ----------------------------------------

REM Recup. de TRANSVERSE_COMMON_PATH 
...
SETLOCAL ENABLEDELAYEDEXPANSION 
    ...
    SET TRANSVERSE_UNDER_TEST_NAME=Vars.bat
    SET TRANSVERSE_UNDER_TEST_PATH=%TRANSVERSE_COMMON_PATH%
...
REM====================================================================================================================
REM ======= Lancement de tous les Tests pour la fonction GetVarValue =======
REM
:GetVarValue_Run_TESTS
	SETLOCAL

    CALL "%MESSAGES_DISPLAYER%" WriteMessage ""		
    CALL "%MESSAGES_DISPLAYER%" WriteMessage "   ****** TEST de GetVarValue ******"

    CALL :GetVarValue_Nominal_ShouldReturnTheAppropriateVarValue
    CALL :GetVarValue_WhenVarDoesntExist_ShouldReturnAnEmptyValue
...
REM ======= GetVarValue_Nominal_ShouldReturnTheAppropriateVarValue =======
:GetVarValue_Nominal_ShouldReturnTheAppropriateVarValue
	SETLOCAL

    CALL "%MESSAGES_DISPLAYER%" WriteMessage "" 2
    CALL "%MESSAGES_DISPLAYER%" WriteMessage "- GetVarValue_Nominal_ShouldReturnTheAppropriateVarValue -"
    
    SET __EXPECTED_VALUE__=100
    SET __VAR_PREFIX__=MY_VAR_PREFIX_
    SET __VAR_SUFFIX__=MY_VAR_SUFFIX
    SET MY_VAR_PREFIX_MY_VAR_SUFFIX=%__EXPECTED_VALUE__%
    CALL :GetVarValue_Run_Test "%__VAR_PREFIX__%" "%__VAR_SUFFIX__%" "%__EXPECTED_VALUE__%"
...
REM ======= GetVarValue_WhenVarDoesntExist_ShouldReturnAnEmptyValue =======
:GetVarValue_WhenVarDoesntExist_ShouldReturnAnEmptyValue
	SETLOCAL

    CALL "%MESSAGES_DISPLAYER%" WriteMessage "" 2
    CALL "%MESSAGES_DISPLAYER%" WriteMessage "- GetVarValue_WhenVarDoesntExist_ShouldReturnAnEmptyValue -"
    
    SET __EXPECTED_VALUE__=
    SET __VAR_PREFIX__=MY_VAR_PREFIX_
    SET __VAR_SUFFIX__=MY_VAR_SUFFIX
    CALL :GetVarValue_Run_Test "%__VAR_PREFIX__%" "%__VAR_SUFFIX__%" "%__EXPECTED_VALUE__%"
...
:GetVarValue_Run_Test
    ...
    CALL "%MESSAGES_DISPLAYER%" WriteMessage " Avec VAR_PREFIX='%__VAR_PREFIX__%' et  VAR_SUFFIX='%__VAR_SUFFIX__%'"

    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" GetVarValue "%__VAR_PREFIX__%" "%__VAR_SUFFIX__%" __RESULT__
    
    CALL "%TESTING_TOOL%" AssertAreEqual "%__RESULT__%" "%__EXPECTED_VALUE__%"
...
:ReplaceSubString_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" ReplaceSubString "%__SOURCE_STRING__%" "%__SOURCE_SUBSTRING_TO_REPLACE__%" "%__REPLACING_STRING__%" __RESULT__
...
:SlashToBackSlash_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" SlashToBackSlash "%__SOURCE_STRING__%" __RESULT__
...
:BackSlashToSlash_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" BackSlashToSlash "%__SOURCE_STRING__%" __RESULT__
...
:PointToSlash_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" PointToSlash "%__SOURCE_STRING__%" __RESULT__
...
:GetStringLength_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" GetStringLength "%__STRING__%" __RESULT__
...
:PadLeft_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" PadLeft "%__STRING__%" "%__FILL_CHAR__%" "%__FINAL_LENGTH__%" __RESULT__
...
:RemoveSubString_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" RemoveSubString "%__STRING__%" "%__SUBSTRING_TO_REMOVE__%" __RESULT__
...
:WithoutSpace_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" WithoutSpace "%__STRING__%" __RESULT__
...
:ContainsSubString_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" ContainsSubString "%__STRING__%" "%__SUBSTRING__%" __RESULT__
...
:EndsWith_Run_Test
    ...
    SET __RESULT__=
    CALL "%TRANSVERSE_UNDER_TEST%" EndsWith "%__STRING__%" "%__ENDING_SUBSTRING__%" "%__WITH_ENDING_SUBSTRING__%" __RESULT__
