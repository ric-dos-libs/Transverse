...
SET FOLDER_PATH_TO_PACKAGE=%$_CURRENT_SCRIPT_PATH_$%
...
IF %PACKAGE_TYPE%. EQU DEV. (
  SET PACKAGES_ROOT_PATH=%$_CURRENT_SCRIPT_PATH_$%/../../..
...
REM --------------------------------------------------------------------
SET SRC_PATH=%$_CURRENT_SCRIPT_PATH_$%
...
ECHO. & ECHO.
CALL "%INFRA_ZIP_SCRIPT%" AddToZip "%PACKAGE_FILE%" "%FOLDER_PATH_TO_PACKAGE%/%LIB_NAME%.*" 
CALL "%INFRA_ZIP_SCRIPT%" AddToZip "%PACKAGE_FILE%" "%FOLDER_PATH_TO_PACKAGE%/_Init.bat" 
...
PUSHD "%$_CURRENT_SCRIPT_PATH_$%"
  ...
  ECHO. & ECHO.
  CALL "%INFRA_ZIP_SCRIPT%" UnZipIt "%PACKAGE_FILE%" "%CD%/%FOLDER_NAME_TO_PACKAGE%"
