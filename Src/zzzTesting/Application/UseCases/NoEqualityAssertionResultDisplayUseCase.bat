...
CALL "%TESTING_DOMAIN_COMMON_SERVICES_PATH%/AssertionsResultEvaluatorService.bat" GetNoEqualityAssertionResult %2 %3 __ASSERTION_RESULT_ID__
ECHO __ASSERTION_RESULT_ID__='!__ASSERTION_RESULT_ID__!'  for  %2 != %3
...
ECHO __CONVERTED_ASSERTION_RESULT_ID__='!__CONVERTED_ASSERTION_RESULT_ID__!'  for  %2 != %3
