...
IF %1. EQU Equality. (
  ...
  CALL "%TESTING_APPLICATION_USE_CASES_PATH%/EqualityAssertionResultDisplayUseCase.bat" __APPLICATION_ASSERTION_RESULT_ID__ %3 %4
  ...
  Rem --- Appel du UseCase ---
  SET __APPLICATION_ASSERTION_RESULT_ID__=
  CALL "%TESTING_APPLICATION_USE_CASES_PATH%/NoEqualityAssertionResultDisplayUseCase.bat" __APPLICATION_ASSERTION_RESULT_ID__ %3 %4
  ...
  Rem --- Appel du UseCase ---
  SET __APPLICATION_ASSERTION_RESULT_ID__=
  CALL "%TESTING_APPLICATION_USE_CASES_PATH%/IsBetweenAssertionResultDisplayUseCase.bat" __APPLICATION_ASSERTION_RESULT_ID__ %3 %4 %5
  ...
  Rem --- Appel du UseCase ---
  SET __APPLICATION_ASSERTION_RESULT_ID__=
  CALL "%TESTING_APPLICATION_USE_CASES_PATH%/DiskElementExistsAssertionResultDisplayUseCase.bat" __APPLICATION_ASSERTION_RESULT_ID__ %3
  ...
  Rem --- Appel du UseCase ---
  SET __APPLICATION_ASSERTION_RESULT_ID__=
  CALL "%TESTING_APPLICATION_USE_CASES_PATH%/DiskElementDoesntExistAssertionResultDisplayUseCase.bat" __APPLICATION_ASSERTION_RESULT_ID__ %3
