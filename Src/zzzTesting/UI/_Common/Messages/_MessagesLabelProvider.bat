...
SET mui_CURRENT_NAMESPACE_mui=Testing.UI._Common.Messages
SET _mui_CURRENT_SCRIPT_NAME_EXT_mui_=%~nx0

SET _$mui_CURRENT_SCRIPT_PATH_mui$_=%~dp0


SET TESTING_UI_COMMON_PATH=%_$mui_CURRENT_SCRIPT_PATH_mui$_%..
...
SETLOCAL
    ...
    CALL "%TESTING_COMMON_VARS_SCRIPT%" GetVarValue "ASSERTION_RESULT_MESSAGE_LABEL_" "%__CONVERTED_ASSERTION_RESULT_ID__%" __MESSAGE_LABEL__
    CALL "%TESTING_COMMON_CHECK_FATAL_ERRORS_SCRIPT%" CheckVarExists "__MESSAGE_LABEL__"
...
:LoadAssertionResultMessageLabelTable
  SET __LANG_ID__=%~1
  SET LANG_MESSAGE_LABEL_TABLE_SCRIPT=%TESTING_UI_COMMON_MESSAGES_PATH%/AssertionResultMessageLabel_%__LANG_ID__%.bat
