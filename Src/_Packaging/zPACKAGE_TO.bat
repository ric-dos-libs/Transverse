...
SET PACKAGE_FILE=%PACKAGE_PATH%/%PACKAGE_NAME%.%__ZIP_EXTENSION__%
...
REM ------------------- INFORMATION --------------------
CALL "%MESSAGES_DISPLAYER%" WriteMessage "" 4
CALL "%MESSAGES_DISPLAYER%" WriteMessage "FIN DE L'OPERATION, dossier des packages :"
