    ...
    SET NB_SECONDS_MESSAGE_TO_SAY_NOT_DELETED=4
		IF EXIST "%__FOLDER__%" (
			...
			IF "%__PROMPT_BEFORE_DELETE__%" EQU "%TRUE%" (
				CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "" 2
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "ATTENTION,"
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "le dossier suivant existe et va etre efface :"
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "" 2
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "'%__FOLDER__%'"
				CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage ""
				PAUSE
				
			) ELSE (
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "" 2
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "SUPPRESSION DU DOSSIER dans %NB_SECONDS_BEFORE_DELETE% sec. :"
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "'%__FOLDER__%'"
				CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "" 2
      ...
      IF EXIST "%__FOLDER__%" (
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "" 2
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "La SUPPRESSION du DOSSIER suivant n'a pas eu lieu :"
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "  '%__FOLDER__%'"
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage ""
        ...
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "" 2
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "La SUPPRESSION du DOSSIER suivant n'a pas eu lieu car il est inexistant :"
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage "  '%__FOLDER__%'"
        CALL "%TRANSVERSE_INFRA_MESSAGES_DISPLAYER%" WriteMessage ""      
    )	
