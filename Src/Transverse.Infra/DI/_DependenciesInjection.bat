...
CALL "%TRANSVERSE_INFRA_DI_PATH%/CommonDependenciesInjection.bat" %1
CALL "%TRANSVERSE_INFRA_DI_PATH%/DomainDependenciesInjection.bat" %1
CALL "%TRANSVERSE_INFRA_DI_PATH%/ApplicationDependenciesInjection.bat" %1
