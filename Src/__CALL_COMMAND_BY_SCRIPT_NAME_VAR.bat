...
REM
REM   %1 : NOM de la VAR. d'env. (entre guillemets) qui contiendra 
REM           -(une fois le ./_Init.bat lancé (ci-dessous))-
REM        le chemin+nom+ext du script concerné.
REM       Pour connaître le NOM des VARS d'env. : consulter ici les divers _Pathes.bat.
REM
...
REM
REM    EXEMPLE : __call_command_by_script_name_var "TRANSVERSE_INFRA_7ZIP_SCRIPT" PartialUnZip "J:/____Common/zzMyLocalPublishedPackages/ClassLibrary1.2.0.0.12.nupkg" "_rels/.rels" "t:/zzzUnPack"
REM 
REM
...
REM                 CALL "NomDeLaVarDEnvContenantCheminNomExtDuScript.bat" NomFonctionDeTypeQuery ... RETURNED_VALUE ...
...
REM ---- Vérifs ----
SET __SCRIPT_TO_LAUNCH_VAR_NAME__=%~1
SET __FUNCTION_TO_LAUNCH__=%2

CALL "%TRANSVERSE_COMMON_CHECK_FATAL_ERRORS_SCRIPT%" CheckVarExists "__SCRIPT_TO_LAUNCH_VAR_NAME__"
CALL "%TRANSVERSE_COMMON_CHECK_FATAL_ERRORS_SCRIPT%" CheckVarExists "__FUNCTION_TO_LAUNCH__"



REM ---- Récup. du script dont lancer une fonction ----
SET __SCRIPT_TO_LAUNCH__=
CALL "%TRANSVERSE_COMMON_VARS_SCRIPT%" GetVarValue "%__SCRIPT_TO_LAUNCH_VAR_NAME__%" "" __SCRIPT_TO_LAUNCH__
@REM ECHO __SCRIPT_TO_LAUNCH__='%__SCRIPT_TO_LAUNCH__%' & PAUSE
