...
REM Recup. de TRANSVERSE_COMMON_CONSTANTS_SCRIPT et TRANSVERSE_COMMON_CHECK_FATAL_ERRORS_SCRIPT
SET TRANSVERSE_COMMON_PATH=%_$_CURRENT_SCRIPT_PATH_$_%
...
:EndsWith
    SETLOCAL ENABLEDELAYEDEXPANSION
      ...
      CALL "%TRANSVERSE_COMMON_CHECK_FATAL_ERRORS_SCRIPT%" CheckValueAmong "%__WITH_ENDING_SUBSTRING__%" "%TRUE%" "%FALSE%"
