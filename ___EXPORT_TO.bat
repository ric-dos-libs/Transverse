...
ECHO. & ECHO.
CALL "%INFRA_ZIP_SCRIPT%" AddToZip "%PACKAGE_FILE%" "%FOLDER_PATH_TO_PACKAGE%%FOLDER_NAME_TO_PACKAGE%" 
...
PUSHD "%CD%"
  ...
  REM - DEZIPPAGE et obtention d'un dossier de nom %FOLDER_NAME_TO_PACKAGE% -
  ECHO. & ECHO.
